...
prefList="com.goteamgecko.tabletop.avatarcreator.plist"
...
# Start the Dragon Breath Dungeon™ avatar creation tool
setDone=$(/usr/bin/defaults read "$setChk" setDone)
if [[ "$setDone" == 0 ]]; then
    # Continue
    echo "Dragon Breath Dungeon™ avatar creation tool continuing"
else
...
baseDir="/Users/$currentUser/Library/Preferences/tabletop/avatars"
avatarplist="com.goteamgecko.tabletop.$avatarName.plist"
...
### Write out the avatar plist
/usr/bin/defaults write "$baseDir/$avatarplist" attribMag "$attribMag"
/usr/bin/defaults write "$baseDir/$avatarplist" attribCom "$attribCom"
/usr/bin/defaults write "$baseDir/$avatarplist" attribRan "$attribRan"
/usr/bin/defaults write "$baseDir/$avatarplist" attribSub "$attribSub"
/usr/bin/defaults write "$baseDir/$avatarplist" attribSte "$attribSte"
/usr/bin/defaults write "$baseDir/$avatarplist" attribStr "$attribStr"
/usr/bin/defaults write "$baseDir/$avatarplist" attribAtt "$attribAtt"
/usr/bin/defaults write "$baseDir/$avatarplist" avatarLevel "$avatarLevel"
/usr/bin/defaults write "$baseDir/$avatarplist" avatarClass "$avatarClass"
/usr/bin/defaults write "$baseDir/$avatarplist" avatarRace "$avatarRace"
/usr/bin/defaults write "$baseDir/$avatarplist" avatarName "$avatarName"
